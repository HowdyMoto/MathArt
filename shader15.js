...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    vec3 col = vec3(0.);
    float lig = 0.;
    // Replace texture lookup with procedural noise for light intensity variation
    float titila = fract(sin(ti * 12.345) * 43758.5453); // procedural noise instead of texture
