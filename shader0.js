// Alien Corridor - Complex fractal architecture
registerShadertoy('Alien Corridor', `
/*
    ALIEN CORRIDOR
    ==============
    A journey through an infinite fractal corridor with organic architecture.
    Features complex lighting, shadows, and animated transformations.
*/
...
/*
    ALIEN CORRIDOR
    - Complex fractal architecture with animated transformations
    - Advanced lighting with hard shadows and ambient occlusion
    - Automatic camera movement through winding path
    - Mouse interaction for looking around
    - Organic, breathing geometry
*/
`);